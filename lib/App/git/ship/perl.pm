...
=head2 share_dirs
  ...
  @dirs = $self->share_dirs;

Returns a list of share_dirs to distribute. For now only looks for share/

This method is used to tdd he C<install_share> in C<Makefile.PL>.
